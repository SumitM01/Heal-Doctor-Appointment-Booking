...
<html>
  ...
  <body>
    ...
    <div class="container h-100 p-5 bg-white rounded">
        <div class="row">
          <div class="col-md-1">
            <a href="<?= base_url('appointments') ?>" class="btn" style="border-radius: 50%;"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
            ...
            <div class="col-md-6">
              ...
              <div class="row">
                <div class = "position-relative start-25">
                  <form id="apt_form" action="/apt-update" method="post">
                    <button class="btn btn-success py-2 w-100" id="submitbutton" type="submit" style="visibility: hidden;">Update Appointment</button>
                    <input type="number" class="form-control" name="aptid" value="<?= htmlspecialchars($id) ?>" style="visibility: hidden;">
                    <!-- <input type="number" class="form-control" name="thrid" style="visibility: hidden;"> -->
                    <!-- <input type="text" class="form-control" name="thrname" value="<?php //htmlspecialchars($therapistName) ?>" style="visibility: hidden;"> -->
