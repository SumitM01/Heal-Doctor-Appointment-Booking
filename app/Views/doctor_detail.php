        ...
        <div class="ba-container">
            ...
            <div class="d-flex" id="main">
                ...
                <div class="flex-grow-1 h-100 p-3 rounded">
                    ...
                    <div class="cover-container p-3 m-3">
                        <div class="row">
                            ...
                            <div class="col-md-7 text-center my-auto">
                                <h5 class="p-5">Dr. Amelia Chopitea Villa is a highly experienced MBBS doctor specializing in internal medicine. With over 10 years of practice in Milan.Her commitment to excellence and continuous learning ensures that her patients receive the highest quality medical care. Whether it's preventive care, diagnosis, or treatment.</h5>
                                <p class="lead">
                                <a href="<?= base_url('/apt-book') ?>?therapist=<?= urlencode('Dr. Amelia Chopitea Villa') ?>" class="btn btn-lg m-4">Book Appointment</a>
                                </p>
                            </div>
                        </div>
                    </div>
